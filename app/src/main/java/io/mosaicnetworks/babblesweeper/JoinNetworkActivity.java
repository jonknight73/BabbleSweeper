...
public class JoinNetworkActivity extends AppCompatActivity  implements ResponseListener  {
...
// joinNetworkClick
            ...
            mHttpGenesisPeerDiscoveryRequest = HttpPeerDiscoveryRequest.createGenesisPeersRequest(peerIP,
                    BabbleService.DISCOVERY_PORT, new ResponseListener() {
                        ...
                        public void onFailure(Error error) {
                            JoinNetworkActivity.this.onFailure(error);
                        }
                    }, this);
    ...
    public void onReceivePeers(List<Peer> currentPeers) {
        ...
        Intent intent = new Intent(JoinNetworkActivity.this, GameActivity.class);
